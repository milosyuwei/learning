...
package com.weiyu.learning.grpc.examples;

import com.google.common.annotations.VisibleForTesting;
import com.google.protobuf.Message;
import com.weiyu.learning.grpc.contract.routeguide.*;
...
public class RouteGuideClient {
    private static final org.slf4j.Logger logger = LoggerFactory.getLogger(RouteGuideClient.class);
    ...
    public void getFeature(int lat, int lon) {
        info("*** GetFeature: lat={} lon={}", lat, lon);
    ...
    public void recordRoute(List<Feature> features, int numPoints) throws InterruptedException {
        info("*** Async RecordRoute");
        final CountDownLatch finishLatch = new CountDownLatch(1);
        StreamObserver<RouteSummary> responseObserver = new StreamObserver<RouteSummary>() {
            @Override
            public void onNext(RouteSummary summary) {
                info("Finished trip with {} points. Passed {} features. "
        ...
        try {
            ...
            for (int i = 0; i < numPoints; ++i) {
                ...
                info("Visiting point {}, {}", RouteGuideUtil.getLatitude(point),
        ...
        logger.info("request on completed");
    ...
    public void routeChat() throws InterruptedException{
        ...
        StreamObserver<RouteNote> requestObserver =
                asyncStub.routeChat(new StreamObserver<RouteNote>() {
                    ...
                    public void onNext(RouteNote note) {
                        info("Got message \"{}\" at {}, {}", note.getMessage(), note.getLocation()
        ...
        try {
            ...
            for (RouteNote request : requests) {
                info("Sending message \"{}\" at {}, {}", request.getMessage(), request.getLocation()
        ...
        if (!finishLatch.await(1, TimeUnit.MINUTES)) {
            warning("routeChat can not finish within 1 minutes");
        }
    }
