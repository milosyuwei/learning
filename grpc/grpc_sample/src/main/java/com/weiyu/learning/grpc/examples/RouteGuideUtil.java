...
import com.weiyu.learning.grpc.contract.routeguide.Feature;
import com.weiyu.learning.grpc.contract.routeguide.FeatureDatabase;
import com.weiyu.learning.grpc.contract.routeguide.Point;
...
public class RouteGuideUtil {
  ...
  public static URL getDefaultFeaturesFile() {
    return Thread.currentThread().getContextClassLoader().getResource("route_guide_db.json");
