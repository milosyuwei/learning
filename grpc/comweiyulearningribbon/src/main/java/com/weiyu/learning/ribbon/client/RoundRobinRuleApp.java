...
public class RoundRobinRuleApp {
    ...
    public static void main(String[] args) throws Exception {
        RoundRobinRuleApp urlLoadBalancer = new RoundRobinRuleApp(Lists.newArrayList(
